 ...
 *
 * Only ever asked about the page being shown. A maximised widget on another page
 * is not on screen at all, and covers nothing.
 */
...
/**
 * Whether the grid still draws this widget.
 *
 * Nothing in the grid is visible while a widget has the whole board, so the grid
 ...
 * picture it wastes.
 *
 * The maximised widget itself is drawn over the board instead, so its slot is
